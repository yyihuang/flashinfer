...
// tvm-ffi dispatch module for kernel family 'cake_dsv4_family_738e81e1831f6bed28a0'.
...
namespace variant_cake_dsv4_d7e601fa53d9522f22d4_sm_100a_95fac861c18d {
...
void Run(TensorView arg_tmap_q, TensorView arg_tmap_swa_k, TensorView arg_tmap_compressed_k, TensorView arg_tmap_swa_v, TensorView arg_tmap_compressed_v, TensorView arg_O, TensorView arg_partial_lse, TensorView arg_swa_indices, TensorView arg_compressed_indices, TensorView arg_sparse_topk_lens, TensorView arg_sinks, TensorView arg_bmm1_scale, TensorView arg_bmm2_scale, int64_t arg_num_heads, int64_t arg_num_query_tokens, int64_t arg_swa_index_stride, int64_t arg_compressed_index_stride, int64_t arg_sparse_topk_lens_offset, int64_t arg_sparse_topk, int64_t arg_has_sinks, int64_t arg_total_work_items, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_dsv4_d7e601fa53d9522f22d4),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_dsv4_d7e601fa53d9522f22d4 failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_d7e601fa53d9522f22d4), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_d7e601fa53d9522f22d4 failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_d7e601fa53d9522f22d4_sm_100a_95fac861c18d

namespace variant_cake_dsv4_46676f5117bdf3c8c810_sm_100a_4aac9911939d {
...
void Run(TensorView arg_partial_O, TensorView arg_partial_lse, TensorView arg_O, int64_t arg_num_q_heads, int64_t arg_num_split, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
  ...
  config.stream = stream;
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_46676f5117bdf3c8c810), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_46676f5117bdf3c8c810 failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_46676f5117bdf3c8c810_sm_100a_4aac9911939d
    ...
    case 0: {
      {
        ...
        int64_t gy = 1;
        int64_t gz = 1;
        cake_host_shim_e1047b0e9e2d7ffc::variant_cake_dsv4_d7e601fa53d9522f22d4_sm_100a_95fac861c18d::Run(arg_Q, arg_SWA_cache, arg_compressed_KV_cache, arg_SWA_cache, arg_compressed_KV_cache, arg_partial_O, arg_partial_lse, arg_swa_indices, arg_compressed_indices, arg_sparse_topk_lens, arg_sinks, arg_bmm1_scale, arg_bmm2_scale, num_heads, num_query_tokens, swa_index_stride, compressed_index_stride, sparse_topk_lens_offset, sparse_topk, has_sinks, total_work_items, gx, gy, gz, stream);
      }
      {
        int64_t gx = num_query_tokens;
        int64_t gy = num_heads;
        int64_t gz = 1;
        cake_host_shim_e1047b0e9e2d7ffc::variant_cake_dsv4_46676f5117bdf3c8c810_sm_100a_4aac9911939d::Run(arg_partial_O, arg_partial_lse, arg_O, num_heads, num_split, gx, gy, gz, stream);
      }
      return;
    }
    default:
      TVM_FFI_CHECK(false, ValueError) << "no dispatch route for cake_dsv4_family_738e81e1831f6bed28a0 shape (num_heads=" << num_heads << ", num_query_tokens=" << num_query_tokens << ", swa_index_stride=" << swa_index_stride << ", compressed_index_stride=" << compressed_index_stride << ", sparse_topk_lens_offset=" << sparse_topk_lens_offset << ", sparse_topk=" << sparse_topk << ", has_sinks=" << has_sinks << ", total_work_items=" << total_work_items << ", num_split=" << num_split << ")";
  }
}
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_e1047b0e9e2d7ffc::Dispatch);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(route_of, cake_host_shim_e1047b0e9e2d7ffc::RouteOf);
