...
kernel_cake_dsv4_0d5faf6792de0982ddbc(const __grid_constant__ CUtensorMap tmap_q, const __grid_constant__ CUtensorMap tmap_swa_k, const __grid_constant__ CUtensorMap tmap_compressed_k, const __grid_constant__ CUtensorMap tmap_swa_v, const __grid_constant__ CUtensorMap tmap_compressed_v, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_lse, int* __restrict__ swa_indices, int* __restrict__ compressed_indices, int* __restrict__ sparse_topk_lens, float* __restrict__ sinks, float* __restrict__ bmm1_scale, float* __restrict__ bmm2_scale, int num_heads, int num_query_tokens, int swa_index_stride, int compressed_index_stride, int sparse_topk_lens_offset, int sparse_topk, int has_sinks, int total_work_items)
{
                ...
                for (int qk_stage_1 = 0; qk_stage_1 < 4; qk_stage_1++) {
                    ...
                    if (lane < 4) {
                        ...
                        if (first_kv_tile_1 == 0) {
                            tma_gather4_gmem2smem_mc_cta2(smem_k_addr + k_stage_1 * 16384 + (unsigned int)(group * 512), (&tmap_swa_k), qk_stage_1 * 128, ((raw_rows[0] >= 0) ? raw_rows[0] : ((1) ? group * 4 : 0)), ((raw_rows[1] >= 0) ? raw_rows[1] : ((1) ? group * 4 + 1 : 0)), ((raw_rows[2] >= 0) ? raw_rows[2] : ((1) ? group * 4 + 2 : 0)), ((raw_rows[3] >= 0) ? raw_rows[3] : ((1) ? group * 4 + 3 : 0)), ((k_full_addr + (k_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                            tma_gather4_gmem2smem_mc_cta2(smem_k_addr + k_stage_1 * 16384 + (unsigned int)(group * 512) + 8192, (&tmap_swa_k), qk_stage_1 * 128 + 64, ((raw_rows[0] >= 0) ? raw_rows[0] : ((1) ? group * 4 : 0)), ((raw_rows[1] >= 0) ? raw_rows[1] : ((1) ? group * 4 + 1 : 0)), ((raw_rows[2] >= 0) ? raw_rows[2] : ((1) ? group * 4 + 2 : 0)), ((raw_rows[3] >= 0) ? raw_rows[3] : ((1) ? group * 4 + 3 : 0)), ((k_full_addr + (k_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                        } else {
                            tma_gather4_gmem2smem_mc_cta2(smem_k_addr + k_stage_1 * 16384 + (unsigned int)(group * 512), (&tmap_compressed_k), qk_stage_1 * 128, ((raw_rows[0] >= 0) ? raw_rows[0] : ((1) ? group * 4 : 0)), ((raw_rows[1] >= 0) ? raw_rows[1] : ((1) ? group * 4 + 1 : 0)), ((raw_rows[2] >= 0) ? raw_rows[2] : ((1) ? group * 4 + 2 : 0)), ((raw_rows[3] >= 0) ? raw_rows[3] : ((1) ? group * 4 + 3 : 0)), ((k_full_addr + (k_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                            tma_gather4_gmem2smem_mc_cta2(smem_k_addr + k_stage_1 * 16384 + (unsigned int)(group * 512) + 8192, (&tmap_compressed_k), qk_stage_1 * 128 + 64, ((raw_rows[0] >= 0) ? raw_rows[0] : ((1) ? group * 4 : 0)), ((raw_rows[1] >= 0) ? raw_rows[1] : ((1) ? group * 4 + 1 : 0)), ((raw_rows[2] >= 0) ? raw_rows[2] : ((1) ? group * 4 + 2 : 0)), ((raw_rows[3] >= 0) ? raw_rows[3] : ((1) ? group * 4 + 3 : 0)), ((k_full_addr + (k_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                        }
                    }
                    k_stage_1 += 1;
                ...
                for (int tile_3 = 1; tile_3 < num_kv_tiles_3; tile_3++) {
                    ...
                    for (int qk_stage_2 = 0; qk_stage_2 < 4; qk_stage_2++) {
                        ...
                        if (lane < 4) {
                            ...
                            tma_gather4_gmem2smem_mc_cta2(smem_k_addr + k_stage_1 * 16384 + (unsigned int)(group_1 * 512), (&tmap_compressed_k), qk_stage_2 * 128, ((raw_rows_1[0] >= 0) ? raw_rows_1[0] : ((1) ? group_1 * 4 : 0)), ((raw_rows_1[1] >= 0) ? raw_rows_1[1] : ((1) ? group_1 * 4 + 1 : 0)), ((raw_rows_1[2] >= 0) ? raw_rows_1[2] : ((1) ? group_1 * 4 + 2 : 0)), ((raw_rows_1[3] >= 0) ? raw_rows_1[3] : ((1) ? group_1 * 4 + 3 : 0)), ((k_full_addr + (k_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                            tma_gather4_gmem2smem_mc_cta2(smem_k_addr + k_stage_1 * 16384 + (unsigned int)(group_1 * 512) + 8192, (&tmap_compressed_k), qk_stage_2 * 128 + 64, ((raw_rows_1[0] >= 0) ? raw_rows_1[0] : ((1) ? group_1 * 4 : 0)), ((raw_rows_1[1] >= 0) ? raw_rows_1[1] : ((1) ? group_1 * 4 + 1 : 0)), ((raw_rows_1[2] >= 0) ? raw_rows_1[2] : ((1) ? group_1 * 4 + 2 : 0)), ((raw_rows_1[3] >= 0) ? raw_rows_1[3] : ((1) ? group_1 * 4 + 3 : 0)), ((k_full_addr + (k_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                        }
                        k_stage_1 += 1;
                        if (k_stage_1 == 3) { k_stage_1 = 0; _phase_k_empty ^= 1; }
                    }
                        ...
                        if (lane < 4) {
                            ...
                            for (int acc_stage_4 = 0; acc_stage_4 < 2; acc_stage_4++) {
                                ...
                                if (first_kv_tile_1 + prev_tile == 0) {
                                    tma_gather4_gmem2smem_mc_cta2(dst_v + group_2 * 512, (&tmap_swa_v), acc_stage_4 * 128 * 2 + cta_rank * 128, ((raw_rows_2[0] >= 0) ? raw_rows_2[0] : ((1) ? group_2 * 4 : 0)), ((raw_rows_2[1] >= 0) ? raw_rows_2[1] : ((1) ? group_2 * 4 + 1 : 0)), ((raw_rows_2[2] >= 0) ? raw_rows_2[2] : ((1) ? group_2 * 4 + 2 : 0)), ((raw_rows_2[3] >= 0) ? raw_rows_2[3] : ((1) ? group_2 * 4 + 3 : 0)), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                    tma_gather4_gmem2smem_mc_cta2(dst_v + group_2 * 512 + 8192, (&tmap_swa_v), acc_stage_4 * 128 * 2 + cta_rank * 128 + 64, ((raw_rows_2[0] >= 0) ? raw_rows_2[0] : ((1) ? group_2 * 4 : 0)), ((raw_rows_2[1] >= 0) ? raw_rows_2[1] : ((1) ? group_2 * 4 + 1 : 0)), ((raw_rows_2[2] >= 0) ? raw_rows_2[2] : ((1) ? group_2 * 4 + 2 : 0)), ((raw_rows_2[3] >= 0) ? raw_rows_2[3] : ((1) ? group_2 * 4 + 3 : 0)), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                } else {
                                    tma_gather4_gmem2smem_mc_cta2(dst_v + group_2 * 512, (&tmap_compressed_v), acc_stage_4 * 128 * 2 + cta_rank * 128, ((raw_rows_2[0] >= 0) ? raw_rows_2[0] : ((1) ? group_2 * 4 : 0)), ((raw_rows_2[1] >= 0) ? raw_rows_2[1] : ((1) ? group_2 * 4 + 1 : 0)), ((raw_rows_2[2] >= 0) ? raw_rows_2[2] : ((1) ? group_2 * 4 + 2 : 0)), ((raw_rows_2[3] >= 0) ? raw_rows_2[3] : ((1) ? group_2 * 4 + 3 : 0)), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                    tma_gather4_gmem2smem_mc_cta2(dst_v + group_2 * 512 + 8192, (&tmap_compressed_v), acc_stage_4 * 128 * 2 + cta_rank * 128 + 64, ((raw_rows_2[0] >= 0) ? raw_rows_2[0] : ((1) ? group_2 * 4 : 0)), ((raw_rows_2[1] >= 0) ? raw_rows_2[1] : ((1) ? group_2 * 4 + 1 : 0)), ((raw_rows_2[2] >= 0) ? raw_rows_2[2] : ((1) ? group_2 * 4 + 2 : 0)), ((raw_rows_2[3] >= 0) ? raw_rows_2[3] : ((1) ? group_2 * 4 + 3 : 0)), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                }
                            }
                        }
                        v_stage_1 += 1;
                    ...
                    if (lane < 4) {
                        ...
                        for (int acc_stage_5 = 0; acc_stage_5 < 2; acc_stage_5++) {
                            ...
                            if (first_kv_tile_1 + last_tile == 0) {
                                tma_gather4_gmem2smem_mc_cta2(dst_v_1 + group_3 * 512, (&tmap_swa_v), acc_stage_5 * 128 * 2 + cta_rank * 128, ((raw_rows_3[0] >= 0) ? raw_rows_3[0] : ((1) ? group_3 * 4 : 0)), ((raw_rows_3[1] >= 0) ? raw_rows_3[1] : ((1) ? group_3 * 4 + 1 : 0)), ((raw_rows_3[2] >= 0) ? raw_rows_3[2] : ((1) ? group_3 * 4 + 2 : 0)), ((raw_rows_3[3] >= 0) ? raw_rows_3[3] : ((1) ? group_3 * 4 + 3 : 0)), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                tma_gather4_gmem2smem_mc_cta2(dst_v_1 + group_3 * 512 + 8192, (&tmap_swa_v), acc_stage_5 * 128 * 2 + cta_rank * 128 + 64, ((raw_rows_3[0] >= 0) ? raw_rows_3[0] : ((1) ? group_3 * 4 : 0)), ((raw_rows_3[1] >= 0) ? raw_rows_3[1] : ((1) ? group_3 * 4 + 1 : 0)), ((raw_rows_3[2] >= 0) ? raw_rows_3[2] : ((1) ? group_3 * 4 + 2 : 0)), ((raw_rows_3[3] >= 0) ? raw_rows_3[3] : ((1) ? group_3 * 4 + 3 : 0)), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                            } else {
                                tma_gather4_gmem2smem_mc_cta2(dst_v_1 + group_3 * 512, (&tmap_compressed_v), acc_stage_5 * 128 * 2 + cta_rank * 128, ((raw_rows_3[0] >= 0) ? raw_rows_3[0] : ((1) ? group_3 * 4 : 0)), ((raw_rows_3[1] >= 0) ? raw_rows_3[1] : ((1) ? group_3 * 4 + 1 : 0)), ((raw_rows_3[2] >= 0) ? raw_rows_3[2] : ((1) ? group_3 * 4 + 2 : 0)), ((raw_rows_3[3] >= 0) ? raw_rows_3[3] : ((1) ? group_3 * 4 + 3 : 0)), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                tma_gather4_gmem2smem_mc_cta2(dst_v_1 + group_3 * 512 + 8192, (&tmap_compressed_v), acc_stage_5 * 128 * 2 + cta_rank * 128 + 64, ((raw_rows_3[0] >= 0) ? raw_rows_3[0] : ((1) ? group_3 * 4 : 0)), ((raw_rows_3[1] >= 0) ? raw_rows_3[1] : ((1) ? group_3 * 4 + 1 : 0)), ((raw_rows_3[2] >= 0) ? raw_rows_3[2] : ((1) ? group_3 * 4 + 2 : 0)), ((raw_rows_3[3] >= 0) ? raw_rows_3[3] : ((1) ? group_3 * 4 + 3 : 0)), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                            }
                        }
                    }
                    v_stage_1 += 1;
    ...
    if (warp == 13) {
        { // index_warp_main
            ...
            for (unsigned int work_idx_4 = cluster_id; work_idx_4 < total_work_items; work_idx_4 += num_clusters) {
                ...
                int owner_col_base = split_idx_3 * (4 / ((1) ? 4 : 1)) * 128;
                ...
                for (int index_pass = 0; index_pass < 4 / ((1) ? 4 : 1); index_pass++) {
                    ...
                    int combined_col = owner_col_base + index_offset_4;
