...
kernel_cake_dsv4_ed6e5d8b61cc89d4664b(const __grid_constant__ CUtensorMap tmap_q, const __grid_constant__ CUtensorMap tmap_swa_kv, const __grid_constant__ CUtensorMap tmap_compressed_kv, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_lse, int* __restrict__ swa_indices, int* __restrict__ compressed_indices, int* __restrict__ sparse_topk_lens, int* __restrict__ seq_lens, int* __restrict__ cum_seq_lens_q, float* __restrict__ sinks, float* __restrict__ bmm1_scale, float* __restrict__ bmm2_scale, int num_heads, int swa_index_stride, int compressed_index_stride, int sparse_topk_lens_offset, int num_query_tokens, int sparse_topk, int has_sinks, int total_work_items, int max_q_len, int batch_size)
{
    ...
    #define source_sum_empty_addr (mbar_base + 264)
    #define o_empty_addr (mbar_base + 272)
    #define o_full_addr (mbar_base + 280)
    #define s_seeded_addr (mbar_base + 288)
    #define q_pair_ready_addr (mbar_base + 296)
    #define kv_pair_ready_addr (mbar_base + 304)
    #define pv_pair_ready_addr (mbar_base + 312)
    #define tmem_dealloc_addr (mbar_base + 328)
    #define tmem_dealloc_peer_addr (mbar_base + 336)
    #define source_work_full_addr (mbar_base + 344)
    #define source_work_empty_addr (mbar_base + 360)
    #define source_throttle_full_addr (mbar_base + 376)
    #define source_throttle_empty_addr (mbar_base + 392)
