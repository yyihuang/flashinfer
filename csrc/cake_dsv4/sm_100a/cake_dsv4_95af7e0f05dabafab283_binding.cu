...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_dsv4_95af7e0f05dabafab283'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
namespace cake_host_shim_e22487e5b87de75b {
...
void Run(TensorView arg_tmap_q, TensorView arg_tmap_swa_k, TensorView arg_tmap_compressed_k, TensorView arg_tmap_swa_v, TensorView arg_tmap_compressed_v, TensorView arg_O, TensorView arg_partial_lse, TensorView arg_swa_indices, TensorView arg_compressed_indices, TensorView arg_sparse_topk_lens, TensorView arg_sinks, TensorView arg_bmm1_scale, TensorView arg_bmm2_scale, int64_t arg_num_heads, int64_t arg_num_query_tokens, int64_t arg_swa_index_stride, int64_t arg_compressed_index_stride, int64_t arg_sparse_topk_lens_offset, int64_t arg_sparse_topk, int64_t arg_has_sinks, int64_t arg_total_work_items, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_e22487e5b87de75b::Run);
