...
kernel_cake_dsv4_356ac41acf7a6a674e25(const __grid_constant__ CUtensorMap tmap_q, const __grid_constant__ CUtensorMap tmap_swa_k, const __grid_constant__ CUtensorMap tmap_compressed_k, const __grid_constant__ CUtensorMap tmap_swa_v, const __grid_constant__ CUtensorMap tmap_compressed_v, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_lse, int* __restrict__ swa_indices, int* __restrict__ compressed_indices, int* __restrict__ sparse_topk_lens, float* __restrict__ sinks, float* __restrict__ bmm1_scale, float* __restrict__ bmm2_scale, int num_heads, int num_query_tokens, int swa_index_stride, int compressed_index_stride, int sparse_topk_lens_offset, int sparse_topk, int has_sinks, int total_work_items)
{
                        ...
                        if (lane < 4) {
                            ...
                            for (int acc_stage_4 = 0; acc_stage_4 < 2; acc_stage_4++) {
                                ...
                                if (first_kv_tile_1 + prev_tile == 0) {
                                    tma_gather4_gmem2smem_mc_cta2(dst_v + group_2 * 512, (&tmap_swa_v), acc_stage_4 * 128 * 2 + cta_rank * 128, ((raw_rows_2[0] >= 0) ? raw_rows_2[0] : _max_2), ((raw_rows_2[1] >= 0) ? raw_rows_2[1] : _max_2), ((raw_rows_2[2] >= 0) ? raw_rows_2[2] : _max_2), ((raw_rows_2[3] >= 0) ? raw_rows_2[3] : _max_2), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                    tma_gather4_gmem2smem_mc_cta2(dst_v + group_2 * 512 + 8192, (&tmap_swa_v), acc_stage_4 * 128 * 2 + cta_rank * 128 + 64, ((raw_rows_2[0] >= 0) ? raw_rows_2[0] : _max_2), ((raw_rows_2[1] >= 0) ? raw_rows_2[1] : _max_2), ((raw_rows_2[2] >= 0) ? raw_rows_2[2] : _max_2), ((raw_rows_2[3] >= 0) ? raw_rows_2[3] : _max_2), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                } else {
                                    tma_gather4_gmem2smem_mc_cta2(dst_v + group_2 * 512, (&tmap_compressed_v), acc_stage_4 * 128 * 2 + cta_rank * 128, ((raw_rows_2[0] >= 0) ? raw_rows_2[0] : _max_2), ((raw_rows_2[1] >= 0) ? raw_rows_2[1] : _max_2), ((raw_rows_2[2] >= 0) ? raw_rows_2[2] : _max_2), ((raw_rows_2[3] >= 0) ? raw_rows_2[3] : _max_2), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                    tma_gather4_gmem2smem_mc_cta2(dst_v + group_2 * 512 + 8192, (&tmap_compressed_v), acc_stage_4 * 128 * 2 + cta_rank * 128 + 64, ((raw_rows_2[0] >= 0) ? raw_rows_2[0] : _max_2), ((raw_rows_2[1] >= 0) ? raw_rows_2[1] : _max_2), ((raw_rows_2[2] >= 0) ? raw_rows_2[2] : _max_2), ((raw_rows_2[3] >= 0) ? raw_rows_2[3] : _max_2), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                }
                            }
                        }
                        v_stage_1 += 1;
                    ...
                    if (lane < 4) {
                        ...
                        for (int acc_stage_5 = 0; acc_stage_5 < 2; acc_stage_5++) {
                            ...
                            if (first_kv_tile_1 + last_tile == 0) {
                                tma_gather4_gmem2smem_mc_cta2(dst_v_1 + group_3 * 512, (&tmap_swa_v), acc_stage_5 * 128 * 2 + cta_rank * 128, ((raw_rows_3[0] >= 0) ? raw_rows_3[0] : _max_3), ((raw_rows_3[1] >= 0) ? raw_rows_3[1] : _max_3), ((raw_rows_3[2] >= 0) ? raw_rows_3[2] : _max_3), ((raw_rows_3[3] >= 0) ? raw_rows_3[3] : _max_3), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                tma_gather4_gmem2smem_mc_cta2(dst_v_1 + group_3 * 512 + 8192, (&tmap_swa_v), acc_stage_5 * 128 * 2 + cta_rank * 128 + 64, ((raw_rows_3[0] >= 0) ? raw_rows_3[0] : _max_3), ((raw_rows_3[1] >= 0) ? raw_rows_3[1] : _max_3), ((raw_rows_3[2] >= 0) ? raw_rows_3[2] : _max_3), ((raw_rows_3[3] >= 0) ? raw_rows_3[3] : _max_3), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                            } else {
                                tma_gather4_gmem2smem_mc_cta2(dst_v_1 + group_3 * 512, (&tmap_compressed_v), acc_stage_5 * 128 * 2 + cta_rank * 128, ((raw_rows_3[0] >= 0) ? raw_rows_3[0] : _max_3), ((raw_rows_3[1] >= 0) ? raw_rows_3[1] : _max_3), ((raw_rows_3[2] >= 0) ? raw_rows_3[2] : _max_3), ((raw_rows_3[3] >= 0) ? raw_rows_3[3] : _max_3), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                                tma_gather4_gmem2smem_mc_cta2(dst_v_1 + group_3 * 512 + 8192, (&tmap_compressed_v), acc_stage_5 * 128 * 2 + cta_rank * 128 + 64, ((raw_rows_3[0] >= 0) ? raw_rows_3[0] : _max_3), ((raw_rows_3[1] >= 0) ? raw_rows_3[1] : _max_3), ((raw_rows_3[2] >= 0) ? raw_rows_3[2] : _max_3), ((raw_rows_3[3] >= 0) ? raw_rows_3[3] : _max_3), ((v_full_addr + (v_stage_1) * 8) & 0xFEFFFFFF), 1 << cta_rank);
                            }
                        }
                    }
                    v_stage_1 += 1;
