...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_dsv4_aa2af576a20f4bba9932'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_dsv4_aa2af576a20f4bba9932(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_lse, __nv_bfloat16* __restrict__ O, int num_heads, int num_splits);


namespace cake_host_shim_68d68c4e51e7a8d8 {
...
void Run(TensorView arg_partial_O, TensorView arg_partial_lse, TensorView arg_O, int64_t arg_num_heads, int64_t arg_num_splits, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_aa2af576a20f4bba9932), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_aa2af576a20f4bba9932 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_68d68c4e51e7a8d8

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_68d68c4e51e7a8d8::Run);
