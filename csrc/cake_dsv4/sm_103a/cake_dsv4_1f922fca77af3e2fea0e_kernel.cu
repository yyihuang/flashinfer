...
kernel_cake_dsv4_1f922fca77af3e2fea0e(const __grid_constant__ CUtensorMap tmap_q, const __grid_constant__ CUtensorMap tmap_swa_kv, const __grid_constant__ CUtensorMap tmap_compressed_kv, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_lse, int* __restrict__ swa_indices, int* __restrict__ compressed_indices, int* __restrict__ sparse_topk_lens, float* __restrict__ sinks, float* __restrict__ bmm1_scale, float* __restrict__ bmm2_scale, int num_heads, int swa_index_stride, int compressed_index_stride, int sparse_topk_lens_offset, int num_query_tokens, int sparse_topk, int has_sinks, int total_work_items)
{
        ...
        { // softmax_wg_main
            ...
            for (unsigned int work_idx_1 = 0; work_idx_1 < 1; work_idx_1++) {
                ...
                for (int tile_1 = 0; tile_1 < num_kv_tiles_1; tile_1++) {
                    ...
                    {
                        float _max_1 = max_noftz(new_max, half_max);
                        new_max = _max_1;
