...
// tvm-ffi dispatch module for kernel family 'cake_dsv4_family_23d5cc579454ccba338a'.
...
extern "C" __global__ void kernel_cake_dsv4_61ce483bde571b30b58e(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_lse, __nv_bfloat16* __restrict__ O, int num_q_heads, int num_split);
extern "C" __global__ void kernel_cake_dsv4_041004cfcc44b5511e4b(const __grid_constant__ CUtensorMap tmap_q, const __grid_constant__ CUtensorMap tmap_swa_k, const __grid_constant__ CUtensorMap tmap_compressed_k, const __grid_constant__ CUtensorMap tmap_swa_v, const __grid_constant__ CUtensorMap tmap_compressed_v, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_lse, int* __restrict__ swa_indices, int* __restrict__ compressed_indices, int* __restrict__ sparse_topk_lens, float* __restrict__ sinks, float* __restrict__ bmm1_scale, float* __restrict__ bmm2_scale, int num_heads, int num_query_tokens, int swa_index_stride, int compressed_index_stride, int sparse_topk_lens_offset, int sparse_topk, int has_sinks, int total_work_items);

namespace cake_host_shim_d2d3b378d98dfeee {
...
namespace variant_cake_dsv4_041004cfcc44b5511e4b_sm_103a_e2d4363ed938 {
...
void Run(TensorView arg_tmap_q, TensorView arg_tmap_swa_k, TensorView arg_tmap_compressed_k, TensorView arg_tmap_swa_v, TensorView arg_tmap_compressed_v, TensorView arg_O, TensorView arg_partial_lse, TensorView arg_swa_indices, TensorView arg_compressed_indices, TensorView arg_sparse_topk_lens, TensorView arg_sinks, TensorView arg_bmm1_scale, TensorView arg_bmm2_scale, int64_t arg_num_heads, int64_t arg_num_query_tokens, int64_t arg_swa_index_stride, int64_t arg_compressed_index_stride, int64_t arg_sparse_topk_lens_offset, int64_t arg_sparse_topk, int64_t arg_has_sinks, int64_t arg_total_work_items, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
  ...
  CheckCudaTensor(arg_swa_indices, "swa_indices");
  CheckDtype(arg_swa_indices, "swa_indices", 0, 32, 1);
  CheckContiguous(arg_swa_indices, "swa_indices");
  CheckCudaTensor(arg_compressed_indices, "compressed_indices");
  CheckDtype(arg_compressed_indices, "compressed_indices", 0, 32, 1);
  CheckContiguous(arg_compressed_indices, "compressed_indices");
  ...
  TVM_FFI_CHECK(arg_num_query_tokens >= -2147483648LL && arg_num_query_tokens <= 2147483647LL, ValueError)
      ...
      << " is outside i32 range [-2147483648, 2147483647]";
  TVM_FFI_CHECK(arg_swa_index_stride >= -2147483648LL && arg_swa_index_stride <= 2147483647LL, ValueError)
      << "scalar 'swa_index_stride' value " << arg_swa_index_stride
      << " is outside i32 range [-2147483648, 2147483647]";
  TVM_FFI_CHECK(arg_compressed_index_stride >= -2147483648LL && arg_compressed_index_stride <= 2147483647LL, ValueError)
      << "scalar 'compressed_index_stride' value " << arg_compressed_index_stride
      << " is outside i32 range [-2147483648, 2147483647]";
  TVM_FFI_CHECK(arg_sparse_topk_lens_offset >= -2147483648LL && arg_sparse_topk_lens_offset <= 2147483647LL, ValueError)
      << "scalar 'sparse_topk_lens_offset' value " << arg_sparse_topk_lens_offset
      << " is outside i32 range [-2147483648, 2147483647]";
  ...
  CheckSameCudaDevice(arg_swa_indices, arg_tmap_q, "swa_indices", "tmap_q");
  CheckSameCudaDevice(arg_compressed_indices, arg_tmap_q, "compressed_indices", "tmap_q");
  ...
  int* p_swa_indices = static_cast<int*>(arg_swa_indices.data_ptr());
  int* p_compressed_indices = static_cast<int*>(arg_compressed_indices.data_ptr());
  ...
  int32_t v_swa_index_stride = (int32_t)arg_swa_index_stride;
  int32_t v_compressed_index_stride = (int32_t)arg_compressed_index_stride;
  int32_t v_sparse_topk_lens_offset = (int32_t)arg_sparse_topk_lens_offset;
  ...
  void* kargs[] = {&p_tmap_q, &p_tmap_swa_k, &p_tmap_compressed_k, &p_tmap_swa_v, &p_tmap_compressed_v, &p_O, &p_partial_lse, &p_swa_indices, &p_compressed_indices, &p_sparse_topk_lens, &p_sinks, &p_bmm1_scale, &p_bmm2_scale, &v_num_heads, &v_num_query_tokens, &v_swa_index_stride, &v_compressed_index_stride, &v_sparse_topk_lens_offset, &v_sparse_topk, &v_has_sinks, &v_total_work_items};
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_dsv4_041004cfcc44b5511e4b),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_dsv4_041004cfcc44b5511e4b failed: "
  ...
  config.dynamicSmemBytes = 220032u;
  config.stream = stream;
  config.attrs = attrs;
  config.numAttrs = n;
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_041004cfcc44b5511e4b), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_041004cfcc44b5511e4b failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_041004cfcc44b5511e4b_sm_103a_e2d4363ed938

namespace variant_cake_dsv4_61ce483bde571b30b58e_sm_103a_a9db487361fe {
...
void Run(TensorView arg_partial_O, TensorView arg_partial_lse, TensorView arg_O, int64_t arg_num_q_heads, int64_t arg_num_split, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
  ...
  config.stream = stream;
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_61ce483bde571b30b58e), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_61ce483bde571b30b58e failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_61ce483bde571b30b58e_sm_103a_a9db487361fe

int SelectVariant(int32_t num_heads, int32_t num_query_tokens, int32_t swa_index_stride, int32_t compressed_index_stride, int32_t sparse_topk_lens_offset, int32_t sparse_topk, int32_t has_sinks, int32_t total_work_items, int32_t num_split) {
  if ((num_split == 4)) return 0;
  return -1;
}

void Dispatch(tvm::ffi::TensorView arg_Q, tvm::ffi::TensorView arg_SWA_cache, tvm::ffi::TensorView arg_compressed_KV_cache, tvm::ffi::TensorView arg_partial_O, tvm::ffi::TensorView arg_partial_lse, tvm::ffi::TensorView arg_swa_indices, tvm::ffi::TensorView arg_compressed_indices, tvm::ffi::TensorView arg_sparse_topk_lens, tvm::ffi::TensorView arg_sinks, tvm::ffi::TensorView arg_bmm1_scale, tvm::ffi::TensorView arg_bmm2_scale, tvm::ffi::TensorView arg_O, int32_t num_heads, int32_t num_query_tokens, int32_t swa_index_stride, int32_t compressed_index_stride, int32_t sparse_topk_lens_offset, int32_t sparse_topk, int32_t has_sinks, int32_t total_work_items, int32_t num_split, int64_t cuda_stream_ptr) {
  ...
  int v = SelectVariant(num_heads, num_query_tokens, swa_index_stride, compressed_index_stride, sparse_topk_lens_offset, sparse_topk, has_sinks, total_work_items, num_split);
  switch (v) {
    case 0: {
      {
        ...
        int64_t gy = 1;
        int64_t gz = 1;
        cake_host_shim_d2d3b378d98dfeee::variant_cake_dsv4_041004cfcc44b5511e4b_sm_103a_e2d4363ed938::Run(arg_Q, arg_SWA_cache, arg_compressed_KV_cache, arg_SWA_cache, arg_compressed_KV_cache, arg_partial_O, arg_partial_lse, arg_swa_indices, arg_compressed_indices, arg_sparse_topk_lens, arg_sinks, arg_bmm1_scale, arg_bmm2_scale, num_heads, num_query_tokens, swa_index_stride, compressed_index_stride, sparse_topk_lens_offset, sparse_topk, has_sinks, total_work_items, gx, gy, gz, stream);
      }
      {
        int64_t gx = num_query_tokens;
        int64_t gy = num_heads;
        int64_t gz = 1;
        cake_host_shim_d2d3b378d98dfeee::variant_cake_dsv4_61ce483bde571b30b58e_sm_103a_a9db487361fe::Run(arg_partial_O, arg_partial_lse, arg_O, num_heads, num_split, gx, gy, gz, stream);
      }
      return;
    }
    default:
      TVM_FFI_CHECK(false, ValueError) << "no dispatch route for cake_dsv4_family_23d5cc579454ccba338a shape (num_heads=" << num_heads << ", num_query_tokens=" << num_query_tokens << ", swa_index_stride=" << swa_index_stride << ", compressed_index_stride=" << compressed_index_stride << ", sparse_topk_lens_offset=" << sparse_topk_lens_offset << ", sparse_topk=" << sparse_topk << ", has_sinks=" << has_sinks << ", total_work_items=" << total_work_items << ", num_split=" << num_split << ")";
  }
}

int64_t RouteOf(int32_t num_heads, int32_t num_query_tokens, int32_t swa_index_stride, int32_t compressed_index_stride, int32_t sparse_topk_lens_offset, int32_t sparse_topk, int32_t has_sinks, int32_t total_work_items, int32_t num_split) { return SelectVariant(num_heads, num_query_tokens, swa_index_stride, compressed_index_stride, sparse_topk_lens_offset, sparse_topk, has_sinks, total_work_items, num_split); }

}  // namespace cake_host_shim_d2d3b378d98dfeee

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_d2d3b378d98dfeee::Dispatch);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(route_of, cake_host_shim_d2d3b378d98dfeee::RouteOf);
