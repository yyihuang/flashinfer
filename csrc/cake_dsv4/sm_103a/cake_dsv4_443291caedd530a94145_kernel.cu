...
kernel_cake_dsv4_443291caedd530a94145(const __grid_constant__ CUtensorMap tmap_q, const __grid_constant__ CUtensorMap tmap_swa_kv, const __grid_constant__ CUtensorMap tmap_compressed_kv, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_lse, int* __restrict__ swa_indices, int* __restrict__ compressed_indices, int* __restrict__ sparse_topk_lens, float* __restrict__ sinks, float* __restrict__ bmm1_scale, float* __restrict__ bmm2_scale, int num_heads, int swa_index_stride, int compressed_index_stride, int sparse_topk_lens_offset, int num_query_tokens, int sparse_topk, int has_sinks, int total_work_items)
{
                        ...
                        : "r"(s_base + 32));
                    {
                        ...
                        if (any_invalid != 0) {
                            ...
                            for (int w_1 = 0; w_1 < 2; w_1++) {
                                ...
                                _tmem_load_1[w_1 * 32] = (((mask_word & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32]);
                                _tmem_load_1[w_1 * 32 + 1] = (((mask_word >> 1 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 1]);
                                _tmem_load_1[w_1 * 32 + 2] = (((mask_word >> 2 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 2]);
                                _tmem_load_1[w_1 * 32 + 3] = (((mask_word >> 3 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 3]);
                                _tmem_load_1[w_1 * 32 + 4] = (((mask_word >> 4 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 4]);
                                _tmem_load_1[w_1 * 32 + 5] = (((mask_word >> 5 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 5]);
                                _tmem_load_1[w_1 * 32 + 6] = (((mask_word >> 6 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 6]);
                                _tmem_load_1[w_1 * 32 + 7] = (((mask_word >> 7 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 7]);
                                _tmem_load_1[w_1 * 32 + 8] = (((mask_word >> 8 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 8]);
                                _tmem_load_1[w_1 * 32 + 9] = (((mask_word >> 9 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 9]);
                                _tmem_load_1[w_1 * 32 + 10] = (((mask_word >> 10 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 10]);
                                _tmem_load_1[w_1 * 32 + 11] = (((mask_word >> 11 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 11]);
                                _tmem_load_1[w_1 * 32 + 12] = (((mask_word >> 12 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 12]);
                                _tmem_load_1[w_1 * 32 + 13] = (((mask_word >> 13 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 13]);
                                _tmem_load_1[w_1 * 32 + 14] = (((mask_word >> 14 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 14]);
                                _tmem_load_1[w_1 * 32 + 15] = (((mask_word >> 15 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 15]);
                                _tmem_load_1[w_1 * 32 + 16] = (((mask_word >> 16 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 16]);
                                _tmem_load_1[w_1 * 32 + 17] = (((mask_word >> 17 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 17]);
                                _tmem_load_1[w_1 * 32 + 18] = (((mask_word >> 18 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 18]);
                                _tmem_load_1[w_1 * 32 + 19] = (((mask_word >> 19 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 19]);
                                _tmem_load_1[w_1 * 32 + 20] = (((mask_word >> 20 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 20]);
                                _tmem_load_1[w_1 * 32 + 21] = (((mask_word >> 21 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 21]);
                                _tmem_load_1[w_1 * 32 + 22] = (((mask_word >> 22 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 22]);
                                _tmem_load_1[w_1 * 32 + 23] = (((mask_word >> 23 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 23]);
                                _tmem_load_1[w_1 * 32 + 24] = (((mask_word >> 24 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 24]);
                                _tmem_load_1[w_1 * 32 + 25] = (((mask_word >> 25 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 25]);
                                _tmem_load_1[w_1 * 32 + 26] = (((mask_word >> 26 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 26]);
                                _tmem_load_1[w_1 * 32 + 27] = (((mask_word >> 27 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 27]);
                                _tmem_load_1[w_1 * 32 + 28] = (((mask_word >> 28 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 28]);
                                _tmem_load_1[w_1 * 32 + 29] = (((mask_word >> 29 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 29]);
                                _tmem_load_1[w_1 * 32 + 30] = (((mask_word >> 30 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 30]);
                                _tmem_load_1[w_1 * 32 + 31] = (((mask_word >> 31 & 1) != 0) ? -CAKE_INF : _tmem_load_1[w_1 * 32 + 31]);
                            }
                        }
                        ...
                        float _max_1 = max_noftz(new_max, _tmem_load_1_max);
                        new_max = _max_1;
