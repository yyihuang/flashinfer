...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_kimi_k3_mla_fp8_paged_attention_6dc0632503e227b97d1d'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_kimi_k3_mla_fp8_paged_attention_6dc0632503e227b97d1d(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_max, float* __restrict__ partial_sum, __nv_bfloat16* __restrict__ O, int* __restrict__ cum_seq_lens_q, int batch, int num_heads, int num_split, float bmm2_scale);


namespace cake_host_shim_34526fb56abc7aa1 {
...
void Run(TensorView arg_partial_O, TensorView arg_partial_max, TensorView arg_partial_sum, TensorView arg_O, TensorView arg_cum_seq_lens_q, int64_t arg_batch, int64_t arg_num_heads, int64_t arg_num_split, double arg_bmm2_scale, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_kimi_k3_mla_fp8_paged_attention_6dc0632503e227b97d1d), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_kimi_k3_mla_fp8_paged_attention_6dc0632503e227b97d1d failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_34526fb56abc7aa1

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_34526fb56abc7aa1::Run);
