...
TVM_FFI_EMBED_CUBIN(gdn_decode_pretranspose_splitv8_4616f441b6);
...
void Run(TensorView arg_q, TensorView arg_k, TensorView arg_v, TensorView arg_state, TensorView arg_A_log, TensorView arg_a, TensorView arg_dt_bias, TensorView arg_b, TensorView arg_out, TensorView arg_initial_state_indices, TensorView arg_output_state_indices, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  void* kargs[] = {&p_q, &p_k, &p_v, &p_state, &p_A_log, &p_a, &p_dt_bias, &p_b, &p_out, &p_initial_state_indices, &p_output_state_indices, &v_state_pool_size};

  static auto kernel = TVM_FFI_EMBED_CUBIN_GET_KERNEL(gdn_decode_pretranspose_splitv8_4616f441b6, "kernel_gdn_decode_pretranspose_splitv8");
