...
// f25f39ca88593945b3b987a291601af5bef94e40960eeedcf9248a93bbe79e63.
// clang-format off
...
kernel_flashinfer_blackwell_bf16_bmm_m16n32k1024_cooperative(__nv_bfloat16* __restrict__ A, __nv_bfloat16* __restrict__ B_tensor, uint8_t* __restrict__ out_bytes, int batch_size, int M, int N, int K, int a_stride_b, int a_stride_m, int a_stride_k, int b_stride_b, int b_stride_k, int b_stride_n, int out_type)
{
