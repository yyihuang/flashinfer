...
// Provenance: generated Loom schedule 'flashkda_bf16_fused_m128' at Cake 9260d51b4d098270f072b4fa5877efebfb2218cb.
// Correctness evidence: f325afdf09; performance evidence: 39a327bd51.
// Raw generated body SHA256: 598a4cc5afb716311ffcb4a43b60307bc5466b621d3352111c3d31e61b8df683 (159221 bytes).
        ...
        { // prep_main
            ...
            for (int prep_iter = 0; prep_iter < num_prep_iters; prep_iter++) {
                ...
                for (int work_pass = 0; work_pass < 4; work_pass++) {
                    ...
                    int kr_workspace_base = ((task_idx_4 * 5 + prep_instance) * 32 + row_1) * 128 + segment_1 * 8;
                    #pragma unroll
                ...
                if (pair_row_base >= pair_col_base) {
                    ...
                    int late_seed_lane = _shfl_xor_8 ^ 1;
                ...
                for (int work_pass_1 = 0; work_pass_1 < 4; work_pass_1++) {
                    ...
                    int kr_workspace_base_1 = ((task_idx_4 * 5 + prep_instance) * 32 + row_2) * 128 + segment_2 * 8;
