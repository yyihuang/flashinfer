...
// Provenance: generated Loom schedule 'flashkda_bf16_fused_m128' at Cake 209b1d1bf2dc48e39a865f34f7dcdb7f742bb0c2.
// Raw generated body SHA256: 27dfd105a397a11f7f5ad8335bde3b57858eb2228504e2e9fd8e8c44a0fea2d3
        ...
        { // prep_main
            ...
            for (int prep_iter = 0; prep_iter < num_prep_iters; prep_iter++) {
                ...
                if (pair_row_base >= pair_col_base) {
                    ...
                    int late_seed_lane = _shfl_xor_11 ^ 1;
                    int seed_lane_row = late_seed_lane % 16;
                    int seed_lane_col = late_seed_lane / 16 * 8;
