...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_msa_nvfp4_decode_adaa705908fd31d92c93'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
void Run(TensorView arg_Q, TensorView arg_K, TensorView arg_K_scale, TensorView arg_V, TensorView arg_V_scale, TensorView arg_O, TensorView arg_msa_lse, TensorView arg_partial_O, TensorView arg_partial_M, TensorView arg_partial_D, TensorView arg_split_completion, TensorView arg_kv_indices, TensorView arg_kv_indptr, TensorView arg_task_kind, TensorView arg_task_request, TensorView arg_task_kv_head, int64_t arg_total_q, int64_t arg_seqlen_q, int64_t arg_num_q_heads, int64_t arg_num_kv_heads, double arg_softmax_scale_log2, double arg_output_scale, int64_t arg_msa_max_pages, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_msa_nvfp4_decode_adaa705908fd31d92c93),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_msa_nvfp4_decode_adaa705908fd31d92c93 failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_msa_nvfp4_decode_adaa705908fd31d92c93), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_msa_nvfp4_decode_adaa705908fd31d92c93 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_9528b9583420cc59

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_9528b9583420cc59::Run);
