...
def trtllm_batch_decode_with_kv_cache(
    ...
    causal_seqlens_kv_global : Optional[torch.Tensor] = None
        ...
        64 and supports the same set. The D256 FP8/page64 ratio-16 profile
        supports ``q_len_per_req`` in ``{1,2,3,4,5,6,7,8}``,
        ``num_qo_heads=16``, ``num_kv_heads=1``, and ``cp_world`` 1 or 4.
        The route can be selected explicitly
        ...
        retain0 split1/2/3/4/8/16 bodies. Size its workspace with
        ``get_dcp_spec_workspace_size_bytes(..., head_dim=256)``. Prewarm a
