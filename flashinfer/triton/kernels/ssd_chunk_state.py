...
def chunk_cumsum_fwd(
    ...
    # Keep one deterministic head tile. Autotuning this headwise-independent
    # preprocessing kernel can select different vector widths across fresh
    # processes, changing BF16 boundary values consumed by the SSD kernel.
    block_size_h = 8
    grid_chunk_cs = (
        batch,
        nchunks,
