...
def get_flash_kda_uri(variant: FlashKDAVariant) -> str:
    ...
    return f"flash_kda_bf16_fused_{variant}_sm103a"


@functools.cache
def gen_flash_kda_module(variant: FlashKDAVariant) -> JitSpec:
    """Generate one exact-sm_103a FlashKDA JIT module.
    ...
    flag; the explicit architecture flags below emit only an sm_103a cubin.
    """
