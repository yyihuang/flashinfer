...
MODULES: dict[str, dict[str, Any]] = {
    ...
    "cake_kimi_k3_mla_fp8_paged_attention_366073d9fac05fa435b9": {
        "arch": "sm_103a",
        "role": "kernel",
        "sources": [
            "cake_kimi_k3_mla/sm_103a/cake_kimi_k3_mla_fp8_paged_attention_366073d9fac05fa435b9_kernel.cu",
            "cake_kimi_k3_mla/sm_103a/cake_kimi_k3_mla_fp8_paged_attention_366073d9fac05fa435b9_binding.cu",
        ],
        "compile_flags": ["--use_fast_math"],
        "ffi_entry": "run",
        "arg_plan": [
        ...
        "closure_sha256": "ae303024839e1ffccfee4b0905c0538baca3857b4d4c287dac9123de2122587e",
        "tma_workspace_bytes": 0,
    },
    ...
    "cake_kimi_k3_mla_fp8_paged_attention_dae17a5d712804dc59ae": {
        "arch": "sm_100a",
        "role": "kernel",
        "sources": [
            "cake_kimi_k3_mla/sm_100a/cake_kimi_k3_mla_fp8_paged_attention_dae17a5d712804dc59ae_kernel.cu",
            "cake_kimi_k3_mla/sm_100a/cake_kimi_k3_mla_fp8_paged_attention_dae17a5d712804dc59ae_binding.cu",
        ],
        "compile_flags": ["--use_fast_math"],
        "ffi_entry": "run",
        "arg_plan": [
        ...
        "closure_sha256": "e5d5c047dbbb261918908b62a175ab861d34fae14cd344115f804a1cdf128140",
        "tma_workspace_bytes": 0,
    },
...
ROUTES: dict[str, dict[str, Any]] = {
    ...
    "main_wide__sm_100a": {
        "arch": "sm_100a",
        "kind": "main_wide",
        "module": "cake_kimi_k3_mla_fp8_paged_attention_dae17a5d712804dc59ae",
    },
    "main_wide__sm_103a": {
        "arch": "sm_103a",
        "kind": "main_wide",
        "module": "cake_kimi_k3_mla_fp8_paged_attention_366073d9fac05fa435b9",
    },
    "reduce_cta__sm_100a": {
        "arch": "sm_100a",
        "kind": "reduce_cta",
