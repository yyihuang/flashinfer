...
_SOURCE_SHA256 = {
    ...
    "cake_msa_decode_m16_fp8_flat.cu": "a76b9bd480cc5b3dceda90e21d8144b9b1b4d3fb6e827e00ebe567bb8890432c",
    "cake_msa_decode_m16_fp8_flat_binding.cu": "06d33e1d1bfc84014f109565ee631cab9541e1ced8d19c80756853196e9a3b92",
    "cake_msa_decode_m16_fp8_paged.cu": "792efd448e05bca7a1875bada28dc5f110c530681c30803828b6257fd1ee9d90",
    "cake_msa_decode_m16_fp8_paged_binding.cu": "b5559d8b44854d271a977517338daad44e4fcdca6520f671cbabf1074b39f47a",
...
def test_cake_msa_frozen_source_inventory_and_sha256():
    ...
    assert len(expected_device_names) == 20
    assert len(expected_binding_names) == 20
